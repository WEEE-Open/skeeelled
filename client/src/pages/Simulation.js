...
import {Card, Row, Col, Pagination, Container, Button, Form, Stack, Modal} from "react-bootstrap";
...
export default function Simulation (props) {
    ...
    const FinishModal = () => {
        ...
        return(
            <>
               <Button className="btn-outline-success" variant="outline-success" onClick={handleShow}>
                   Finish
               </Button>
